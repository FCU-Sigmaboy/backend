...
// ===================================================================
// ### 單一物品詳情 API - v4.1.1（2025-11-18）
// ### Migration v4.1.1 修復內容：
// ###   - ✅ 修復所有者無法查看已下架物品的缺陷
// ###   - ✅ 地點驗證邏輯調整為僅針對非所有者
// ###   - ✅ 允許所有者查看地點缺失的物品（編輯狀態）
// ###
 ...
 *
 * 🔄 Migration v4.1.1 Hotfix (2025-11-18):
 *   - 修復所有者無法查看已下架物品的缺陷
 *   - 地點驗證邏輯調整為僅針對非所有者
 *   - 允許所有者查看自己的物品（無論地點是否完整）
 *
 * 買家位置策略：
 ...
 * - 'ITEM_NOT_FOUND': 物品不存在或已下架（僅非所有者會收到此錯誤）
 * - 'LOCATION_NOT_FOUND': 賣家未設定指定的地點類型（僅非所有者查詢時返回）
